...
class ProjectAdd:
    ...
    def getspread(self):
        ...
        if (self.nearshore_cb == False and self.offshore_cb == False):
            on_shore_spread = 1
        elif (self.nearshore_cb == False and (self.timezone ==5 or self.availability ==5)):
            on_shore_spread = 1
        else:
            on_shore_spread = on_shore_score/(on_shore_score + near_shore_score + off_shore_score)
        if self.nearshore_cb == False:
            near_shore_spread = 0
            if self.offshore_cb == False or self.timezone ==5 or self.availability ==5:
             ...
             near_shore_score = near_shore_score/(on_shore_score + near_shore_score + off_shore_score)
        if self.offshore_cb == True:
            if self.availability ==5 or self.timezone ==5:
                off_shore_spread = 0
                if self.nearshore_cb == True:
